@auth
    <nav class="navbar navbar-expand-lg navbar-dark mb-3" style="background-color: darkorange">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav ml-auto">
                <a class="nav-link text-white" href="{{ asset('prestamo') }}">Inicio</a>
                <a class="nav-link text-white" href="{{ route('prestamo.reportes') }}">Reportes</a>
